...
public class Task2 {
    public static void main(String[] args){
        ChessPiece[][] chessBoardArray = new ChessPiece[][]{
                {ChessPiece.ROOK_BLACK, ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.ROOK_BLACK, ChessPiece.KNIGHT_BLACK, ChessPiece.EMPTY},
        ...
        ChessBoard chessBoard = new ChessBoard(chessBoardArray);
        chessBoard.print();
    }
}
